<?php echo Form::open(array("class"=>"form-horizontal form-label-left", "action" => "/admin/categories/update/".$category->id)); ?>  
    ...
    <div class="form-group">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <fieldset disabled>
          <input type="text" value="<?php echo date("d-m-Y H:i:s", $category->created_at) ?>" class="form-control"/>
        </fieldset>
      </div>
    </div>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        <a href="<?php echo "/admin/categories/destroy/".$category->id ?>" type="button" class="btn btn-success">Yes, I'm sure</a>
      </div>
